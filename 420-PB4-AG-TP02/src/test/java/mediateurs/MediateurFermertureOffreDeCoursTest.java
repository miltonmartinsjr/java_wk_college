...
public class MediateurFermertureOffreDeCoursTest {

    private final MediateurAnnulationOffreDeCours mediateurAnnulationOffreDeCours =
        Mockito.mock(MediateurAnnulationOffreDeCours.class);

    private final MediateurGenerationFactureOffreDeCours mediateurGenerationFactureOffreDeCours =
        Mockito.mock(MediateurGenerationFactureOffreDeCours.class);
    ...
    public MediateurFermertureOffreDeCoursTest() {
    ...
    public void test() {
        ...
        mediateurFermertureOffreDeCours.executer(offreDeCours);
