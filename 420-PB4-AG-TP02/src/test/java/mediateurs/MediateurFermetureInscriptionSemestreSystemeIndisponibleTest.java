...
public class MediateurFermetureInscriptionSemestreSystemeIndisponibleTest {
    ...
    public MediateurFermetureInscriptionSemestreSystemeIndisponibleTest() {
    ...
    public void test() {
        ...
        OffreDeCours offreDeCours =
            new OffreDeCours(cours, etudiant2, etudiants, profTest, semestre, statusOffreDeCours);
